module.exports = `const poster = (rootId, name, tag, img, text) => {
...
document.getElementById("next-p").onclick = (e) => {
  ...
  document.getElementById("next-value-p").value = postArr;
  const bt_value = document.getElementById("next-value-p").value;
